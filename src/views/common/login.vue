    ...
    <div class="site-content__wrapper">
      <div class="site-content">
        <div class="brand-info">
          <h2 class="brand-info__text">东冠快速开发平台</h2>
          <p class="brand-info__intro">dgcloud-fast-vue基于vue、element-ui构建开发，实现dgcloud-fast后台管理前端功能，提供一套更优的前端解决方案。</p>
        </div>
...
<style lang="scss">
  .site-wrapper.site-page--login {
    ...
    bottom: 0;
    left: 0;
    background-color: rgba(38, 50, 56, .001);
    overflow: hidden;
    &:before {
      position: fixed;
      top: 0;
